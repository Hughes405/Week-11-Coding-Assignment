...
public class ProjectsApp {
	...
	private void updateProjectDetails() {
		...
		Integer projectDifficulty = getIntInput("Enter project difficulty(1-5) [" + curProject.getDifficulty() + "]");
		BigDecimal projectEstimatedHours = getDecimalInput(
				"Enter estimated hours for project [" + curProject.getEstimatedHours() + "]");
		BigDecimal projectActualHours = getDecimalInput(
				"Enter actual hours for project [" + curProject.getActualHours() + "]");
		...
		project.setEstimatedHours(
				Objects.isNull(projectEstimatedHours) ? curProject.getEstimatedHours() : projectEstimatedHours);
